...
urlpatterns = [
    ...
    path("tickets/bulk-assign/", views.bulk_assign_tickets, name="bulk_assign_tickets" ),
    path("filter-tickets/", views.filter_tickets, name="filter_tickets"),
    path('tickets/bulk-action/', views.bulk_action_tickets, name='bulk_action_tickets'),
    path("recycle-bin/",views.recycle_bin, name="recycle_bin"),
    path( "restore-ticket/<int:ticket_id>/", views.restore_ticket, name="restore_ticket"),
    path( "permanent-delete/<int:ticket_id>/",views.permanent_delete_ticket,name="permanent_delete_ticket"),
